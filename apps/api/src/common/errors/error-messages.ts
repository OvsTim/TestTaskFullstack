export const ErrorMessages = {
  ...
  WORK_TYPE_NOT_FOUND: 'Вид работ не найден',
  INVALID_WORK_TYPE_ID: 'Некорректный идентификатор вида работ',
  WORK_TYPE_NAME_EXISTS: 'Вид работ с таким названием уже существует',
